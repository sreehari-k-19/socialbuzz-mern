...
export const getComments =async(postId)=>await axios.get(`${baseURL}/post/${postId}/comment`,)

export const addComment =async(postId,data)=>await axios.post(`${baseURL}/post/${postId}/comment`,data)